...
import { $ as $$PageLayout } from '../chunks/PageLayout_56pJNQwh.mjs';
import { $ as $$HeroText } from '../chunks/HeroText_DQyeEvvq.mjs';
import { $ as $$Pricing$1 } from '../chunks/Pricing_Bdi9-vhG.mjs';
import { $ as $$Steps, a as $$FAQs } from '../chunks/Steps_2UWoyhu1.mjs';
import { $ as $$Features3 } from '../chunks/Features3_BtFoYfjs.mjs';
import { $ as $$CallToAction } from '../chunks/CallToAction_n5hmnqFA.mjs';
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "Tarifs", "title": "Des offres transparentes, factur\xE9es en Suisse", "subtitle": "Chaque pack inclut la conception, la mise en ligne et un accompagnement humain. Maintenance et automatisations sont propos\xE9es selon vos besoins." })}  ${renderComponent($$result2, "Prices", $$Pricing$1, { "title": "Nos packs cl\xE9s-en-main", "subtitle": "Choisissez l\u2019offre qui correspond \xE0 votre besoin. Sans frais cach\xE9s.", "prices": [
    {
      ...
      price: 999,
      period: "CHF \u2014 paiement unique",
      items: [
        {
          description: "Site vitrine 5 sections + page contact responsive"
        },
        {
          description: "Contenus r\xE9dig\xE9s en fran\xE7ais et optimis\xE9s pour l\u2019Arc l\xE9manique"
        },
        {
          description: "H\xE9bergement suisse & certificat SSL inclus 12 mois"
        },
        {
          description: "Formation vid\xE9o + check-list d\u2019autonomie"
        }
      ],
      callToAction: {
    ...
    },
    {
      ...
      subtitle: "Site + 1 flux Zapier/Make",
      price: 1200,
      period: "CHF \u2014 paiement unique",
      items: [
        {
        ...
        {
          description: "Connexion \xE0 un outil via Zapier ou Make (1 automatisation)"
        },
        {
          description: "Tests de bout en bout et documentation simple"
        },
        {
          description: "Jusqu\u2019\xE0 4 automatisations&nbsp;: 1\u202F500 CHF"
        }
      ],
      callToAction: {
        text: "Demander un devis automatisation",
        href: "/contact#form"
      },
      hasRibbon: true,
      ribbonTitle: "Plus demand\xE9"
    },
    {
      title: "Maintenance s\xE9curit\xE9",
      subtitle: "Mises \xE0 jour et emails pro",
      price: 79,
      period: "CHF / mois \u2014 sans surprise",
      items: [
        {
        ...
        {
          description: "Gestion des emails professionnels @votredomaine.ch"
        },
        {
      ...
      callToAction: {
        text: "Activer la maintenance",
        href: "/contact#form"
      }
    }
  ] })}  ${renderComponent($$result2, "Features3", $$Features3, { "title": "Avantages inclus", "subtitle": "Toutes nos offres comprennent ces garanties.", "columns": 2, "items": [
    {
    ...
    {
      title: "H\xE9bergement souverain",
      description: "Serveurs situ\xE9s en Suisse, conformit\xE9 RGPD/LPD et certificat SSL inclus.",
      icon: "tabler:server"
    },
    {
      title: "Tableau de bord client",
      description: "Suivez l\u2019avancement, partagez vos contenus et validez chaque \xE9tape en ligne.",
...
De la signature à la mise en ligne, chaque étape est horodatée et documentée dans votre espace client.
    ...
    {
      title: "Comment facturez-vous les automatisations suppl\xE9mentaires ?",
      description: "Chaque flux additionnel est chiffr\xE9 \xE0 l\u2019avance. Trois \xE0 quatre automatisations standards sont factur\xE9es 1\u202F500 CHF."
    },
    {
      title: "La maintenance est-elle obligatoire ?",
      description: "Non. Vous pouvez g\xE9rer votre site en autonomie ou nous confier la maintenance \xE0 79 CHF/mois, r\xE9siliable avec un pr\xE9avis de 30 jours."
    },
    {
