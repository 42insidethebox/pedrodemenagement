...
import { $ as $$Hero } from '../chunks/Hero_5W-BzaCC.mjs';
import { $ as $$Stats } from '../chunks/Stats_q62rrkNK.mjs';
import { $ as $$Steps2 } from '../chunks/Steps2_0uZSKrTC.mjs';
...
MonWebsite.ch est née à Lausanne pour offrir aux PME et indépendants un site web haut de gamme, livré rapidement et sans
...
` })}` })}  ${renderComponent($$result2, "Stats", $$Stats, { "title": "Nos rep\xE8res", "stats": [
    { title: "Rayon d\u2019action", amount: "Arc l\xE9manique" },
    { title: "Approche", amount: "Automatisation + humain" },
    { title: "Maintenance", amount: "Option 79 CHF/mois" },
    { title: "Langues", amount: "FR \xB7 EN \xB7 DE" }
...
Nous opérons depuis Lausanne, Genève, Vevey et Montreux pour rester au plus proche des réalités terrain de nos clients.
  ...
  ] })}  ${renderComponent($$result2, "Steps2", $$Steps2, { "title": "Notre histoire", "subtitle": "Nous construisons une plateforme capable de livrer des sites irr\xE9prochables sans compromis sur l\u2019accompagnement.", "isReversed": true, "callToAction": {
    text: "D\xE9couvrir nos offres",
    href: "/pricing"
  }, "items": [
    {
      title: "2021 \u2014 Lancement",
      description: "Cr\xE9ation de MonWebsite.ch \xE0 Lausanne avec l\u2019objectif de simplifier la pr\xE9sence web des ind\xE9pendants.",
      icon: "tabler:flag"
    },
    {
      title: "2022 \u2014 Industrialisation",
      description: "D\xE9ploiement de nos pipelines automatis\xE9s et ouverture de points de pr\xE9sence \xE0 Gen\xE8ve et Vevey.",
      icon: "tabler:arrows-exchange"
    },
    {
      title: "2023 \u2014 Acc\xE9l\xE9ration",
      description: "Lancement de notre offre multilingue et partenariats renforc\xE9s avec des agences locales.",
      icon: "tabler:rocket"
    }
  ] })}  ${renderComponent($$result2, "Features2", $$Features2, { "title": "O\xF9 nous rencontrer", "tagline": "Pr\xE9sence locale", "columns": 4, "items": [
    {
      title: "Lausanne",
      description: "Quartier Flon \u2014 rendez-vous sur demande"
    },
    {
      title: "Gen\xE8ve",
      description: "Rue du Rh\xF4ne \u2014 showroom partenaires"
    },
    {
      title: "Vevey",
      description: "Espace de coworking La Forge \u2014 sessions onboarding"
    },
    {
      title: "Montreux",
      description: "Studios photo partenaires pour vos shootings"
    }
  ] })} ` })}`;
