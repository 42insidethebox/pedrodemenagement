...
import { $ as $$Note, a as $$Features } from '../chunks/Features_wSFwt5rF.mjs';
import { $ as $$Features2 } from '../chunks/Features2_sHlwcKky.mjs';
import { $ as $$Steps, a as $$FAQs } from '../chunks/Steps_2UWoyhu1.mjs';
import { $ as $$Content } from '../chunks/Content_D0jejRr1.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const metadata = {
    title: "MonWebsite.ch \u2014 Schweizer Websites f\xFCr den Genfersee-Raum",
  ...
  ], "image": { src: "~/assets/images/hero-image.png", alt: "MonWebsite.ch Oberfl\xE4che" } }, { "subtitle": ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "subtitle" }, { "default": ($$result4) => renderTemplate`
Schweizer Design, kontrollierte Performance. MonWebsite.ch verbindet Automatisierung mit lokaler Expertise, um verlässliche
...
` })}` })} ${renderComponent($$result2, "Note", $$Note, { "title": "Versprechen", "description": "Lokaler Service, menschlicher Support und automatisierte Abl\xE4ufe f\xFCr ein makelloses Resultat ohne Zusatzaufwand." })} ${renderComponent($$result2, "Features", $$Features, { "id": "features", "tagline": "Warum wir", "title": "Schweizer Pr\xE4zision f\xFCr Ihren digitalen Auftritt", "subtitle": "Jedes Projekt folgt einem klaren Rahmen: Briefing, Gestaltung, Freigabe und begleiteter Go-Live.", "items": [
    ...
    },
    {
      ...
      description: "Sicherheits-Updates, Backups und Uptime-Checks f\xFCr CHF 79/Monat \u2013 damit Ihre Seite ohne Aufwand aktuell bleibt.",
...
Typische Lieferung: fünf Arbeitstage nach Eingang Ihrer Inhalte. Wir passen den Plan an Ihre Prioritäten an.
    ...
    },
    {
      ...
      description: "Ja, wir schreiben oder \xFCberarbeiten Ihre franz\xF6sischen Texte mit lokalem SEO-Fokus. Englische oder deutsche Versionen bieten wir auf Anfrage an."
    },
    {
      title: "Was umfasst der Serviceplan f\xFCr CHF 79/Monat?",
      description: "Sicherheitsupdates, regelm\xE4ssige Backups, Uptime-Monitoring und Verwaltung Ihrer professionellen E-Mail-Konten."
    },
    {
      title: "Bietet ihr Automatisierungen an?",
      description: "Ja. Eine einfache Integration via Zapier oder Make startet bei CHF 1\u2019200. F\xFCr drei bis vier Automationen rechnen Sie mit CHF 1\u2019500. Jeder Flow wird im Angebot detailliert."
    },
    {
      title: "Wie funktioniert der Support nach dem Launch?",
      description: "Sie erhalten Zugang zu unserem Kundenportal f\xFCr Tickets. Antworten erfolgen innerhalb eines Arbeitstages per E-Mail oder geplanter Video-Session."
    }
