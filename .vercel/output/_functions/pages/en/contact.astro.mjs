import { c as createComponent, r as renderComponent, a as renderTemplate } from '../../chunks/astro/server_Dp0aUUie.mjs';
import { $ as $$PageLayout, c as footerDataEn, d as headerDataEn } from '../../chunks/PageLayout_C1NlzRGT.mjs';
import { $ as $$HeroText } from '../../chunks/HeroText_CNjFG3yD.mjs';
import { $ as $$Contact$1 } from '../../chunks/Contact_Di3hgkSE.mjs';
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata, "header": headerDataEn, "footer": footerDataEn }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "Contact", "title": "Let\u2019s discuss your turnkey site", "subtitle": "A TonSiteWeb.ch expert replies within one business day." })} ${renderComponent($$result2, "ContactUs", $$Contact$1, { "id": "form", "title": "Request a demo or quote", "subtitle": "Fill out the form and we\u2019ll call or schedule a video meeting to prepare your launch (typical timeline: 5 business days).", "inputs": [
    {
      type: "text",
      name: "name",
      label: "Full name"
    ...
    label: "By submitting this form you agree that TonSiteWeb.ch processes your data to answer your request, in line with our privacy policy."
    ...
    },
    {
      ...
      description: "support@tonsiteweb.ch \u2014 reply within one business day",
      icon: "tabler:help"
    }
  ] })} ` })}`;
