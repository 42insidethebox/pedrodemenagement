...
import { $ as $$PageLayout, c as footerDataIt, d as headerDataIt } from '../chunks/PageLayout_56pJNQwh.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const metadata = {
    title: "MonWebsite.ch \u2014 Siti svizzeri chiavi in mano per l\u2019Arco lemanico",
  ...
  ], "image": { src: "~/assets/images/hero-image.png", alt: "Interfaccia MonWebsite.ch" } }, { "subtitle": ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "subtitle" }, { "default": ($$result4) => renderTemplate`
Design svizzero, performance controllata. MonWebsite.ch combina automazione ed esperienza locale per consegnare siti
...
` })}` })} ${renderComponent($$result2, "Note", $$Note, { "title": "Impegno", "description": "Servizio locale, supporto umano e orchestrazione automatizzata per un risultato impeccabile senza sforzo." })} ${renderComponent($$result2, "Features", $$Features, { "id": "features", "tagline": "Perch\xE9 sceglierci", "title": "Precisione svizzera applicata al digitale", "subtitle": "Ogni progetto segue un quadro chiaro: raccolta dati, design, validazione e messa online guidata.", "items": [
    ...
    {
      title: "Piano di cura opzionale",
      description: "Aggiornamenti di sicurezza, backup e controllo uptime a CHF 79/mese per mantenere il sito sempre aggiornato.",
...
Consegna tipica: cinque giorni lavorativi dopo aver ricevuto i contenuti. Adeguiamo la pianificazione alle tue priorità.
    ...
    },
    {
      ...
      description: "S\xEC, scriviamo o ottimizziamo i testi in francese con focus locale. Versioni inglese o tedesca sono quotate a parte."
    },
    {
      title: "Cosa include il piano a CHF 79/mese?",
      description: "Aggiornamenti di sicurezza, backup regolari, monitoraggio uptime e gestione delle email professionali."
    },
    {
      title: "Offrite automazioni?",
      description: "S\xEC. Un\u2019integrazione semplice via Zapier o Make parte da CHF 1\u2019200. Per tre-quattro automazioni considera CHF 1\u2019500. Ogni flusso \xE8 dettagliato nel preventivo."
    },
    {
      title: "Come funziona il supporto dopo il lancio?",
      description: "Hai accesso al nostro portale clienti per aprire ticket. Rispondiamo entro un giorno lavorativo via email o video pianificata."
    }
