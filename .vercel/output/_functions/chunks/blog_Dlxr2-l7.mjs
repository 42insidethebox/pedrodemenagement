...
import { k as AstroError, G as UnknownContentCollectionError, c as createComponent, H as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, J as renderUniqueStylesheet, K as renderScriptElement, O as createHeadAndContent, r as renderComponent } from './astro/server_CGLXZ7Kv.mjs';
import * as devalue from 'devalue';
import { d as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './permalinks_DJ3XW3-H.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dae9XE3q.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_SUPABASE_ANON_KEY": "sb_publishable_ljnYvnf_nSuWE53JUH2iHg_5dHlJiHx", "PUBLIC_SUPABASE_URL": "https://hnicnupamewtitegifyw.supabase.co", "SITE": "https://monwebsite.ch", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CHcjmYBv.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DgD3EaXY.mjs');
