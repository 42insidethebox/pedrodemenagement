...
const SITE = {"name":"MonWebsite.ch","site":"https://monwebsite.ch","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"fr","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"MonWebsite.ch","template":"%s — MonWebsite.ch"},"description":"Agence digitale suisse : sites vitrines clés-en-main pour PME et indépendants de l'Arc lémanique, avec un accompagnement transparent.","openGraph":{"type":"website","site_name":"MonWebsite.ch","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"@monwebsite","site":"@monwebsite","cardType":"summary_large_image"}};
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getAsset as a, getCanonical as b, getPermalink as c, cleanSlug as d, getFormattedDate as e, getBlogPermalink as f, getHomePermalink as g, trimSlash as t };
