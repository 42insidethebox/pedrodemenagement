...
Les présentes conditions générales (les « Conditions ») régissent les prestations fournies par **IOPartner.ch**, marque exploitée par TonSiteWeb Sàrl.

## 1. Objet

IOPartner.ch conçoit, déploie et maintient des sites vitrines pour des entreprises et indépendants. Les Conditions décrivent les droits et obligations applicables à toute commande passée via notre site, par e-mail ou par signature électronique d'une offre.
...
Sauf accord différent, l'hébergement est assuré auprès de fournisseurs cloud certifiés. Vous restez propriétaire de votre nom de domaine ; IOPartner.ch peut en assurer la gestion technique sur mandat écrit.
