...
Cette politique décrit la manière dont **IOPartner.ch** collecte et traite les données personnelles de ses clients et prospects.

## 1. Responsable de traitement

TonSiteWeb Sàrl est responsable des traitements décrits dans ce document. Vous pouvez nous contacter à **support@iopartner.ch**.
...
Pour exercer ces droits, écrivez-nous à **support@iopartner.ch**. Nous répondrons sous 30 jours.
...
Pour toute question relative à la protection des données, contactez **support@iopartner.ch**.
