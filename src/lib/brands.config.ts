...
export const BRANDS: Record<BrandKey, BrandProfile> = {
  ...
  onglesgel: {
    ...
    shortName: 'Ivanna',
    domain: 'onglesgel.ch',
    seoTitle: 'Ongles Gel Lausanne — Pose gel, extensions & nail art',
    seoDescription:
      'Studio de pose gel, extensions et nail art à Lausanne Centre. Résultats durables, ambiance zen, créations sur mesure.',
    primaryColor: '#D4246E',
    secondaryColor: '#F0D4A8',
    fonts: { sans: 'Manrope', heading: 'Cormorant Garamond', serif: 'Cormorant Garamond' },
    theme: {
      bg: '#FAF8F5',
      surface: '#F3EFE9',
      card: '#FAF8F5',
      accent: '#B87C6A',
      pattern: 'none',
      shadow: '0 18px 60px -42px rgba(184, 124, 106, 0.18)',
    },
    phone: '077 240 33 87',
    email: 'contact@onglesgel.ch',
    legalOperator: 'Ivanna Cortes',
  },
  paintballmaceio: {
    key: 'paintballmaceio',
    ...
    seoTitle: 'Paintball Maceió — Adrenalina & diversão em Maceió, AL',
    seoDescription:
      'A melhor arena de paintball de Maceió. Pacotes para grupos, aniversários e eventos corporativos. Reserve pelo WhatsApp.',
    primaryColor: '#E84C0A',
    secondaryColor: '#2D4A1E',
    fonts: { sans: 'Inter', heading: 'Barlow Condensed', serif: 'Inter' },
    theme: {
      bg: '#090C07',
      surface: '#111510',
      card: '#161C13',
      accent: '#E84C0A',
      pattern: 'none',
      shadow: '0 20px 60px -30px rgba(232,76,10,0.3)',
    },
    phone: '+55 82 99999-0000',
  ...
  iopartner: {
    ...
    shortName: 'IOPartner',
    domain: 'iopartner.ch',
    seoTitle: 'IOPartner — Web systems, Linux infrastructure, and operator advisory',
    seoDescription:
  ...
  'exostif-coiffure': {
    ...
    name: 'Exostif Coiffure',
    shortName: 'Exostif',
    domain: 'exostif.ch',
    seoTitle: 'Exostif Coiffure — Salon de coiffure à Lausanne',
    seoDescription:
      'Salon de coiffure professionnel à Lausanne : coupes précises, colorations, soins capillaires et coiffures mariage. Note 4.6/5 sur Google.',
    primaryColor: '#EDE7E1',
    secondaryColor: '#C8957A',
    fonts: { sans: 'DM Sans', heading: 'Cormorant Garamond', serif: 'Cormorant Garamond' },
    theme: {
      bg: '#0F0B09',
      surface: '#1C1410',
      ...
      accent: '#C8957A',
      pattern: 'none',
      shadow: '0 18px 60px -42px rgba(200, 149, 122, 0.22)',
    },
    phone: '0213232803',
    email: 'contact@exostif.ch',
    legalOperator: 'Exostif Coiffure',
  },
};
